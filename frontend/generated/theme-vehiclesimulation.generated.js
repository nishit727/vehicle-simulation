...
import stylesCss from 'themes/vehiclesimulation/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_vehiclesimulation_componentCss']) {
    
    document['_vaadintheme_vehiclesimulation_componentCss'] = true;
  }
